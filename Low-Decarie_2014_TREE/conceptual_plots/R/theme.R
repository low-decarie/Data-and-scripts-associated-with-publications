...
theme(
  ...
  axis.text.x = element_text(family = base_family,size = base_size * 0.9, lineheight = 0.9, vjust = 0), 
  axis.text.y = element_text(family = base_family, size = base_size * 0.9, lineheight = 0.9, hjust = 1), 
  ...
  legend.key.width = NULL, legend.text = element_text(family = base_family, size = base_size * 1), 
